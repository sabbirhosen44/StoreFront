...
export default function CartPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-background text-foreground">
      {/* Banner Component */}
      <div className="w-full bg-[url('/images/cart-bg.jpg')] bg-cover bg-center py-20 border-b border-border/10 relative">
      ...
      <div className="container-center py-12 lg:py-20">
        {items.length === 0 ? (
          <div className="text-center py-20 flex flex-col items-center">
            ...
            <Link
              href="/products"
              className="inline-flex items-center h-12 px-12 border border-furniro-gold text-furniro-gold font-medium rounded-sm hover:bg-furniro-gold hover:text-white transition-all cursor-pointer"
            >
              Fill Your Cart
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2 overflow-x-auto scrollbar-none w-full">
            ...
            {/* Totals Frame Card */}
            <div className="bg-furniro-beige dark:bg-card border border-border/10 rounded-xl p-8 flex flex-col items-center text-center shadow-xs">
              ...
              <div className="w-full space-y-5 text-sm sm:text-base border-b border-border/20 pb-6 mb-6">
                ...
                <div className="flex justify-between px-4">
                  ...
                  <span className="text-furniro-gold font-bold text-lg sm:text-xl">
                    $
                    {subtotal.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                    })}
              ...
              <Link
                href="/checkout"
                className="w-full inline-flex items-center justify-center h-14 border border-foreground rounded-xl text-base font-normal text-foreground hover:bg-foreground hover:text-background transition-colors tracking-wide cursor-pointer shadow-xs"
              >
                Check Out
              </Link>
            </div>
